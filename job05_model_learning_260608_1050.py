...
# 2. 전처리 데이터 로드
# ------------------------------------------------------------------------------------------------
x_train = np.load('data/x_train_wordsize12282_260608_1050.npy', allow_pickle=True)
y_train = np.load('data/y_train_wordsize12282_260608_1050.npy', allow_pickle=True)
x_test = np.load('data/x_test_wordsize12282_260608_1050.npy', allow_pickle=True)
y_test = np.load('data/y_test_wordsize12282_260608_1050.npy', allow_pickle=True)
...
# ------------------------------------------------------------------------------------------------
model = Sequential()
model.add(Embedding(12282, 300))                                # 단어 임베딩
model.build(input_shape=(None, 26))                                               # 입력 크기 설정
...
model.save('./models/news_section_classifier_260608_1050_{}.h5'.format(score[1]))
